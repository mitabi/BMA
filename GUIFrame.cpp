...
GUIFrame::GUIFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_TableData = new wxDataViewListCtrl( m_panel1, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxDV_HORIZ_RULES|wxDV_ROW_LINES|wxDV_SINGLE|wxDV_VARIABLE_LINE_HEIGHT|wxDV_VERT_RULES|wxNO_BORDER );
	...
	bSizer6->Add( m_TableData, 1, wxEXPAND|wxFIXED_MINSIZE, 5 );
	...
	// Connect Events
	this->Connect( wxEVT_ACTIVATE, wxActivateEventHandler( GUIFrame::OnAutoRefresh ) );
	this->Connect( wxEVT_ACTIVATE_APP, wxActivateEventHandler( GUIFrame::OnAutoRefresh ) );
...
{
	// Disconnect Events
	this->Disconnect( wxEVT_ACTIVATE, wxActivateEventHandler( GUIFrame::OnAutoRefresh ) );
	this->Disconnect( wxEVT_ACTIVATE_APP, wxActivateEventHandler( GUIFrame::OnAutoRefresh ) );
...
AddItemFrame::AddItemFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	ButtonAddItem->SetMinSize( wxSize( -1,30 ) );
